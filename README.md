...
**Description**: ABN test was conducted on 2 advertising test groups of the same type, but different rewards for 4 days. The user base for this campaign is mainly in the 4 countries, having certain similar patterns and behaviors while using apps. After that, the data analysis was performed to check the significance, make comparision in performance between 2 options 
